    ...
    // ----------- Phần Skill --------------
    {
        ...
        content: [
            ...
            },
            {
                ...
                text: "Nên lựa chọn các kỹ năng phù hợp với công việc đang ứng tuyển, và đặt các kỹ năng quan trọng nhất lên đầu danh sách"
            },
            {
            ...
            {
                titleContent : "",
                text: "tư duy phản biện , tư duy logic , tư duy tranh luận "
            }
            ],
            // Phần ví dụ
            [
    ...
    // ----------- Phần Project --------------
    {
        ...
        content: [
            ...
            [
            {
                ...
                text: "Luôn cố gắng liệt kê hết tất cả những dự án phù hợp nhất mà bạn đã thực hiện. Với sinh viên, việc có các dự án cá nhân hoặc nhóm là cách tốt nhất để bù đắp cho sự thiếu kinh nghiệm làm việc trong ngành"
            },
            {
    ...
    // ----------- Phần in4 ------------------
    {
        ...
        content: [
            ...
            },
            {
                ...
                text: "Bạn có thể thêm đường dẫn tới website cá nhân cũng như các tài khoản mạng xã hội việc làm như Linkedin mà bạn đang sử dụng. (Không nên sử dụng mạng xã hội cá nhân như Facebook vì có thể trang cá nhân của bạn sẽ chứa những thông tin đời tư không liên quan tới công việc)"
            }
            ],
            // Phần ví dụ
            [
...
function getRemainingHeight(section_measuring) {
    ...
    if(getTemplateCV_Now() == "paper_mau1" || getTemplateCV_Now() == "paper_mau8"){ 
        ...
        return paperHeight - titleHeading - paddingBottom*2 - styles_hdCV - bug_length.length * 12 - margin_part_ct_inCv;
    }
        ...
        if(title_hd && in4_in_ct){
            ...
            return paperHeight - paddingBottom - bug_length.length * 12 - height_pdt - margin_part_ct_inCv;
        }
    }
    else if(getTemplateCV_Now() == "paper_mau6" || getTemplateCV_Now() == "paper_mau7" || getTemplateCV_Now() == "paper_mau9"){
        ...
        if(getTemplateCV_Now() == "paper_mau0" || getTemplateCV_Now() == "paper_mau2"){
            ...
            return paperHeight - headingHeight - paddingBottom - check - (bug_length.length * 12) - margin_part_ct_inCv - (getalltagLi.length * 2);
        }
...
function redistributeContent_when_Addele_2col(part_in_paper) {
    ...
    papers.forEach(paper=>{
        ...
        let itemsInPart = Array.from(paper.querySelector(`.${type}`).querySelectorAll(".item_in_part"));
        let excessParts = [];
        const maxHeight = getRemainingHeight(currentPaper) // lấy ra chiều dài tối đa 
...
partProject.innerHTML = `<section class="bold item_in_part possible_Part title">
                        ...
                        <section class="list_project ct_in_sectionSM">
                            <section team="" fatherpart="project" class="projects paragraph item_in_part">
                                    ...
                                    <table>
                                        <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part"> Khách Hàng</b>
                                            </td>
                                            <td class="half_right_of_content_item">
                                                <p class="client_project type_3 possible_Part"> Nội Dung </p>
                                            </td>
                                        </tr>
                                        <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part"> Mô Tả</b>
                                            </td>
                                            <td class="half_right_of_content_item">
                                                <p class="descriptions_project type_3 possible_Part"> Nội Dung </p>
                                            </td>
                                        </tr>
                                        <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part"> Team Size</b>
                                            </td>
                                            <td class="half_right_of_content_item">
                                                <p class="number_of_members_project type_3 possible_Part"> 3 </p>
                                            </td>
                                        </tr>
                                        <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part"> Vị Trí</b>
                                            </td>
                                            <td class="half_right_of_content_item">
                                                <p class="position_project type_3 possible_Part"> Nội Dung </p>
                                            </td>
                                        </tr>
                                        <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part"> Vai Trò</b>
                                            </td>
                                            <td class="half_right_of_content_item">
                                                <p class="responsibilities_project type_3 possible_Part"> Nội Dung </p>
                                            </td>
                                        </tr>
                                        <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part"> Công Nghệ Sử Dụng</b>
                                            </td>
                                            <td class="half_right_of_content_item">
                                                <p class="technology_in_use_project type_3 possible_Part"> Nội Dung </p>
                                            </td>
                                        </tr>
                                    </table>
                                </section>    
                            ...
                            <section team="" fatherpart="awards" class="content_in_CV paragraph item_in_part"> 
                                ...
                                <section class="half_right_of_content_item my_award projectcv">
                                    <section class="bold possible_Part">
                                        <p class="title_item type_2">F8 TECHNOLOGY EDUCATION.,JSC</p>
                                    </section>
                        ...
                        <section class="ct_in_sectionSM">
                            <section team="" fatherpart="another" class="content_in_CV paragraph item_in_part"> 
                                ...
                                <section class="half_right_of_content_item my_award project">
                                    ...
                                    <section>
                                        <p class="content_item type_2 possible_Part">
                                            Poly creation contest: http://goo.gl/BVP5kE
                                        </p>
                                    </section>
                                </section>
...
function editContent(ele,mauCV) {
    ...
    moveUp.addEventListener("click", function() {
        if(ele.classList.contains("part_ct")){
            ...
            if(ele.previousElementSibling === null){
                ...
                swapElements1(combine_the_parts(ele),elekhac[elekhac.length - 1]);
                if(getTemplateCV_Now() == "paper_mau0" || getTemplateCV_Now() == "paper_mau2"){
                    redistributeContent_when_Addele();
                }
                else{
                ...
                // combine_the_parts(ele);
                swapElements1(combine_the_parts(ele),elekhac);
                if(getTemplateCV_Now() == "paper_mau0" || getTemplateCV_Now() == "paper_mau2"){
                    redistributeContent_when_Addele();
                }
                else{
    ...
    moveDown.addEventListener("click", function() {
        ...
        //             let elekhac;
        //             elekhac = ele.closest(".paper").nextElementSibling.querySelector(".part_ct");
        //             combine_the_parts(ele);
        //             swapElements1(elekhac,ele);
        //         }
        //         else{
    ...
    // Hàm dùng chung để xử lý sự kiện click của addUp và addDown
            ...
            if(check_part_avai(e,parts_exists) == false ) e.classList.add("not_available");
                ...
                e.onclick = function() {
                    ...
                    if (position === "before") {
                        ...
                        ele.insertAdjacentElement("afterend", (parts == "skill") ? partSkill : (parts == "project") ? partProject : (parts == "awards") ? partAwards : (parts == "goals") ? partworkGoals : (parts == "certificate") ? partCertificate : (parts == "language") ? partLanguage : (parts == "overview") ? partOverview : (parts == "workexperience") ? partworkExp : (parts == "education") ? partEducation : partAnother);                        
                        if(getTemplateCV_Now() == "paper_mau10" || getTemplateCV_Now() == "paper_mau9" || getTemplateCV_Now() == "paper_mau8" || getTemplateCV_Now() == "paper_mau6" || getTemplateCV_Now() == "paper_mau4" || getTemplateCV_Now() == "paper_mau1"){
...
function Mau3(paper){
    ...
    if(introduce || title_HD || in4_individual ){
        ...
        contentCV.style.marginTop = `${sp_part.offsetHeight}px`;  
        contentCV.style.padding = "0";
...
function CheckStyleCV(res){
    ...
    const observer1 = new MutationObserver((mutations) => {
        ...
        if(res == 0 || res == 2){
            Item_in_each_Part = document.querySelectorAll('.item_in_part');
            Item_in_each_Part.forEach(function(ele){
            ...
            Item_in_each_Part = document.querySelectorAll(".item_in_part");
            console.log(Item_in_each_Part);
            Item_in_each_Part.forEach(function(ele){
                ele.addEventListener('input',function(){
                    if(ele.closest(".half-left")){
                        redistributeContent_2col(ele.closest(".half-left"));
                    } else {
                        redistributeContent_2col(ele.closest(".half-right"));
                    }
                });
            });   
        }
...
function cutIMG(){
    ...
    if(vung_up_file.childNodes[0].tagName == 'IMG' || imgCVnoww.src !== "./img/8a9d6e85a93b8b3a8002896da71882a3.jpg"){
...
function renderCVbyidcv(check){
    ...
    if(!check){
        let idcv = readIDCVinURL(currentURL);
        ...
        .then(dat=>{
            ...
            if(dat.overviews.length > 0){
                if(!overView){
                    ...
                    div.classList.add("content_in_CV","paragraph","item_in_part");
                        ...
                        let cont = `<section class="name_project">
                                    ...
                                    <section>
                                        <table>
                                            ...
                                            <td class="half_right_of_content_item">
                                            <p class="client_project type_3 possible_Part">${ele.client}</p>
                                            </td>
                                            </tr>
                                            <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                            ...
                                            <td class="half_right_of_content_item">
                                            <p class="descriptions_project type_3 possible_Part">${ele.descriptions}</p>
                                            </td>
                                            </tr>
                                            <tr class="content_in_CV">
                                            <td class="half_left_of_content_item">
                                                ...
                                                <td class="half_right_of_content_item">
                                                    <p class="number_of_members_project type_3 possible_Part">${ele.number_of_members}</p>
                                                    </td>
                                                    </tr>
                                                    <tr class="content_in_CV">
                                                    <td class="half_left_of_content_item">
                                                    ...
                                                    <td class="half_right_of_content_item">
                                                    <p class="position_project type_3 possible_Part">${ele.position}</p>
                                                    </td>
                                                    </tr>
                                                    <tr class="content_in_CV">
                                                    <td class="half_left_of_content_item">
                                                    ...
                                                    <td class="half_right_of_content_item">
                                                    <p class="responsibilities_project type_3 possible_Part">${ele.responsibilities}</p>
                                                    </td>
                                                    </tr>
                                            <tr class="content_in_CV">
                                                <td class="half_left_of_content_item">
                                                    ...
                                                    <td class="half_right_of_content_item">
                                                    <p class="technology_in_use_project type_3 possible_Part">${ele.technology_in_use}</p>
                                                    </td>
                                                    </tr>
                                                    </table>
                                                    </section>`
                        ...
                        let cont = `<section class="name_project">
                                        ...
                                        <section>
                                            <table>
                                                <tr class="content_in_CV">
                                                <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part">${ele.client}</b>
                                                </td>
                                                <td class="half_right_of_content_item">
                                                <p class="client_project type_3 possible_Part"> Nội Dung </p>
                                                </td>
                                                ...
                                                <tr class="content_in_CV">
                                                <td class="half_left_of_content_item">
                                                <b class="type_3 possible_Part">${ele.descriptions}</b>
                                                </td>
                                                <td class="half_right_of_content_item">
                                                <p class="descriptions_project type_3 possible_Part"> Nội Dung </p>
                                                </td>
                                                ...
                                                <tr class="content_in_CV">
                                                <td class="half_left_of_content_item">
                                                        <b class="type_3 possible_Part">${ele.number_of_members}</b>
                                                    </td>
                                                    <td class="half_right_of_content_item">
                                                        <p class="number_of_members_project type_3 possible_Part"> Nội Dung </p>
                                                        </td>
                                                        </tr>
                                                        <tr class="content_in_CV">
                                                        <td class="half_left_of_content_item">
                                                        <b class="type_3 possible_Part">${ele.position}</b>
                                                        </td>
                                                        <td class="half_right_of_content_item">
                                                        <p class="position_project type_3 possible_Part"> Nội Dung </p>
                                                        </td>
                                                        ...
                                                        <tr class="content_in_CV">
                                                        <td class="half_left_of_content_item">
                                                        <b class="type_3 possible_Part">${ele.responsibilities}</b>
                                                        </td>
                                                        <td class="half_right_of_content_item">
                                                        <p class="responsibilities_project type_3 possible_Part"> Nội Dung </p>
                                                        </td>
                                                        ...
                                                        <tr class="content_in_CV">
                                                        <td class="half_left_of_content_item">
                                                        <b class="type_3 possible_Part">${ele.technology_in_use}</b>
                                                        </td>
                                                        <td class="half_right_of_content_item">
                                                        <p class="technology_in_use_project type_3 possible_Part"> Nội Dung </p>
                                                        </td>
            ...
            if(dat.otherParts.length > 0){
                if(!otherPart){
                    paper_.querySelector(`.${dat.otherParts[0].container}`).insertAdjacentElement("beforeend",partAnother);
                    title_in_part = `<section class="bold item_in_part possible_Part title">
                                <i class="fa-solid fa-graduation-cap"></i>
                                <p>
                                    Khác
            ...
            title_cv.forEach(function(ele){
                ele.addEventListener("click", function(event) {
                    editContent(ele.closest(".part_ct"));
                });
            });
...
async function updateCV(contentYourCv){
    let api = `http://localhost:5028/api/NguoiDung/Update_DetailsCVbyID?userid=${userIdnow}&idcv=${IDCVwhenChoose}`;
    let getDetailsCVbyID = `http://localhost:5028/api/NguoiDung/user/getDetailsCVbyID?userid=${userIdnow}&idcv=${IDCVwhenChoose}`;
    // làm api update img 
...
if(btn_save_yourCV){
    btn_save_yourCV.onclick = async ()=>{
        ...
        await Deletebe4Update(IDCVwhenChoose); // làm nhiệm vụ xóa phần còn lại của CV cũ 
        await addDatatoUpdate(contentYourCv,IDCVwhenChoose); // thêm mới nội dung mới vào phần còn lại vừa xóa 
...
async function SaveyourCV(a){
    ...
    if(information || workexperience || education || skill || awards || goals || certificate || language || another){
    ...
    if(part){
        ...
        listwe.forEach(el=>{
            ...
            if(el.querySelector(".timeline")){
                obj_form1.time = el.querySelector(".timeline").innerText;
            }
            if(el.querySelector("p.title_item")){
                obj_form1.title = el.querySelector("p.title_item").innerText;
            }
...
let testadm = "add";
if(IDCVwhenChoose){
    testadm = localStorage.getItem("status");
}
console.log(testadm);
if(testadm == "update"){
...
// bug mẫu 8 khi render ra thì cv mẫu 8,2 bị lỗi màu 
// bug khi render ra CV thì còn 1 vài mẫu với các phần k thể nhập dữ liệu vào 
// xóa hết dữ liệu tại bảng cũ và thêm mới toàn bộ dữ liệu mới 
// bug xóa phần tử con trong part_ct và bug hiển thị/ ẩn phần thêm 
// bug ảnh hiển thị và cắt ảnh bên ngoài CV \
// bug khi render ra giao diện CV thì nó bị rời rạc các phần con 
// lỗi gấp đôi dữ liệu khi render ra ( Lỗi này xuất hiện khi nhấn lưu CV nhiều lần)
// lỗi ở currentColor
// lỗi khi đổi màu khi sửa thì nội dug liền bị reset 
// lôic hiển thị phần lớn khi đã thêm 
// bug thêm phần mới thì có nhưng phần có line phía dưới thì nó chưa có ( mau10 , mau9 mau8 mau1 mau4 mau6)
// trước khi thêm phần mới thì gọi hàm check xem mẫu Cv nào và tiến hành thêm class have_line 
// sử dụng 1 biến check nếu đã chọn mẫu CV thì nó sẽ true còn h thì false và gọi hàm xử lý mặc định 
// chưa test xem ảnh nếu cắt thì có thể lưu vào quản lý CV hay không 
// xây dựng hàm khi bôi đen và nhấn nút nó sẽ hiện ra vị trí bắt đầu và kết thúc 
// đồng thời xây dựng 1 hàm cắt đi nội dung cũ đã bôi và chọn để thêm phần mới với thẻ cấu hình tương ứng 
// [1] cắt hình ảnh khi đã chọn 
// [2] lỗi khi tải xuống 
// [3] lỗi căn lề khi tạo tờ mới và fill vào chỗ bị xóa 

function addDatatoUpdate(contentYourCv,idcvnow){
    let overview = "http://localhost:5028/api/NguoiDung/overview";
    let experience = "http://localhost:5028/api/NguoiDung/experience";
    let education = "http://localhost:5028/api/NguoiDung/Education";
    let projects = "http://localhost:5028/api/NguoiDung/Projects";
...
async function Deletebe4Update(idcv) {
    // lấy ra các phần lớn htai của CV nếu name == với 1 ptu trog mảng của endpoints thì mới call api 
    let currentPart_available = Array.from(content_left.querySelectorAll(".part_ct")).map(ele=>{
        return ele.getAttribute("class").split(" ")[0]
    })
    console.log(currentPart_available);
    const endpoints = {
    ...
    currentPart_available.forEach(e=>{
        if(endpoints[e]){
            fetch(endpoints[e], {
                method: 'DELETE',
                headers: {
